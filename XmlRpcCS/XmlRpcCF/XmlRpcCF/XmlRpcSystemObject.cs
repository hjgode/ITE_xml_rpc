    ...
    public class XmlRpcSystemObject
    {
        ...
        public XmlRpcSystemObject(XmlRpcServer server)
        {
            ...
            try
            {
                ...
                _methodHelp.Add(fullName + ".methodHelp", "Return a string description.");
            }
            catch (Exception ex)
            {
        ...
        static public Object Invoke(Object target, String methodName, IList parameters)
        {
            ...
            try
            {
                //Object retValue = method.Invoke(target, args); //not usable for variant count of args!
                Object retValue = method.Invoke(target, new Object[] { parameters });
                if (retValue == null)
